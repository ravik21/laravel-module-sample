...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Choose which filesystem you wish to use to store the avatar
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | Set the fields that are required to be populated to be considered a
    | complete profile
    */
    'completed_profile' => [
        'first_name',
...
//        }
    ...
    */
    ...
    'pusher'  => [
      'PUSHER_APP_ID'       => 121212,
      'PUSHER_APP_KEY'      => 'foivnfoivnoinv',
      'PUSHER_APP_SECRET'   => 'sdlvknvio',
